...
def return_calibration_results(confidence, correct, method_name='Baseline'):

    rms = 100 * calib_err(confidence, correct, p='2')

    mad = 100 * calib_err(confidence, correct, p='1')
    
    soft = 100 * soft_f1(confidence, correct)
    return rms, mad, soft
